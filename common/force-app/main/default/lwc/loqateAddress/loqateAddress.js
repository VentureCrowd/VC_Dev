...
export default class loqateAdress extends LightningElement {
    ...
    options =[
        ...
        { label: 'Republic of South Sudan', value: 'SS'},
    ...
    loqateret(addId){
        ...
        .then(res => {
            ...
            this.city = res.attributes['City'];
            this.template.querySelector('[data-id="city"]').value = this.city;
            this.state = res.attributes['ProvinceName'];
    ...
    @api checkValidity(){
        ...
        let inputareaelements  = this.template.querySelectorAll('lightning-textarea');
        let allelements = Array.from(inputelements).concat(Array.from(inputareaelements));
    ...
    clearFieldvalues(){
        ...
        this.template.querySelector('[data-id="state"]').value = '';
        this.template.querySelector('[data-id="zip"]').value = '';
        this.template.querySelector('[data-id="country"]').value = '';
        this.street = '';
        this.city = '';
        this.state = '';
        this.postcode = '';
