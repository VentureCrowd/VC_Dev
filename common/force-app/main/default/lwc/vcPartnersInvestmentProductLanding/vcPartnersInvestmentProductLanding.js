...
export default class CurrentInvestmentProductLanding extends LightningElement {
    ...
    @api Investment_Tile_3_BGImageURL;
    @api Investment_Tile_3_Headline;
    @api Investment_Tile_3_Body;
    @api Investment_Tile_3_URL;
    @api openInSameOrNew;
    ...
    get tile_3_Style() {
        return `background-image: url('${this.Investment_Tile_3_BGImageURL}')`;
    }
    ...
    get tile_3_url_Style() {
        let pointerEvent;
        if (this.Investment_Tile_3_URL) {
            pointerEvent = 'auto';
        } else {
            pointerEvent = 'none';
        }
    ...
    get urlLinkTarget() {
        return this.anchorTarget[this.linkSameOrNew];
    }
}