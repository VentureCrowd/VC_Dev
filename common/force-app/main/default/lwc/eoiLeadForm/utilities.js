export const phoneNumberoptns = [
        { value: '93', label: 'Afghanistan +93' },
        { value: '358-AX', label: 'Åland +358' },
        ...
        { value: '672-AQ', label: 'Antarctica +672' },
        ...
        { value: '599-BQ', label: 'Bonaire +599' },
        ...
        { value: '61-CX', label: 'Christmas Island +61' },
        { value: '61-CC', label: 'Cocos [Keeling] Islands +61' },
        ...
        { value: '599-CW', label: 'Curaçao +599' },
        { value: '357', label: 'Cyprus +357' },
        { value: '420', label: 'Czech Republic +420' },
        { value: '45', label: 'Denmark +45' },
        { value: '253', label: 'Djibouti +253' },
        { value: '1767-DM', label: 'Dominica +1767' },
        { value: '1767-DO', label: 'Dominican Republic +1767' },
        ...
        { value: '590-GP', label: 'Guadeloupe +590' },
        { value: '1671', label: 'Guam +1671' },
        { value: '502', label: 'Guatemala +502' },
        { value: '44-GG', label: 'Guernsey +44' },
        { value: '224', label: 'Guinea +224' },
        { value: '245', label: 'Guinea-Bissau +245' },
        { value: '595-GY', label: 'Guyana +595' },
        ...
        { value: '262-YT', label: 'Mayotte +262' },
        ...
        { value: '595-PY', label: 'Paraguay +595' },
        ...
        { value: '262-RE', label: 'Réunion +262' },
        ...
        { value: '590-SX', label: 'Sint Maarten +590' },
        ...
        { value: '500-SG', label: 'South Georgia and the South Sandwich Islands +500' },
        { value: '211', label: 'South Sudan +211' },
        { value: '34', label: 'Spain +34' },
        { value: '94', label: 'Sri Lanka +94' },
        { value: '249', label: 'Sudan +249' },
        { value: '597', label: 'Suriname +597' },
        { value: '47-SJ', label: 'Svalbard and Jan Mayen +47' },
        ...
        { value: '44-UK', label: 'United Kingdom +44' },
